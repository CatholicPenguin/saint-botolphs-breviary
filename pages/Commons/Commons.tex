...
Be loos'd from our iniquity.%MANUAL ADJUSTMENT:\\
...
\hymnLett{T}{h'eternal} gifts of Christ the King,
...
\mattinsOfficeHymn\label{ApostlesMattins}
...
And hooks of steel, their torturers stand.%MANUAL ADJUSTMENT:\\
...
\begin{hymnRubric}
	The Invitatory Hymn is from the Common of Many Martyrs (p. \pageref{MartyrsInvitatory}).
\end{hymnRubric}
...
Now and for ever.%MANUAL ADJUSTMENT:\\
...
To Father and to Paraclete. Amen.%MANUAL ADJUSTMENT:\\
\end{hangparas}
...
\begin{rubric}
	The Hymn of I Evensong \& the Versicle of Mattins.
\end{rubric}
...
\begin{rubric}
	The Hymn of the Common of a Confessor Bishop (p. \pageref{ConfessorBishopEvensong}).
\end{rubric}
...
\begin{rubric}
	The Hymn from I Evensong of the Common of a Confessor Bishop (p. \pageref{ConfessorBishopEvensong}).
\end{rubric}
...
\mattinsOfficeHymn\label{VirginMattins}

\begin{rubric}
	The Hymn as in I Evensong.
\end{rubric}
...
\begin{rubric}\label{VirginOnlyCollect}
...
\begin{rubric}
	The Hymn \& Versicle of Mattins, except for the following Antiphon if it be for One Martyress not a Virgin.
\end{rubric}
...
\begin{rubric}
	The Hymn being the \nth{4} and \nth{5} stanzas of the Invitatory Hymn of the Common of Virgins (p. \pageref{VirginInvitatory}).
\end{rubric}
...
\begin{rubric}
	The Hymn \& Versicle of I Evensong.
\end{rubric}
