...
Whom he had made might live afresh.%MANUAL ADJUSTMENT:\\
...
\textls[-15]{They made creation's Shepherd known.}\\
...
%MANUAL ADJUSTMENT:
%To correct typesetting for PDF:
{\color{white}.}
...
In forty days of yearly round.%MANUAL ADJUSTMENT:\\
...
\begin{rubric}
	If the service of Easter Even be not celebrated, then I Evensong is said as usual.
\end{rubric}
...
%MANUAL ADJUSTMENT:
\clearpage
\seasonSubsection{First Class Double}{First Sunday after Easter}{FestiveWhite}
\feastday{Easter I}
...
\begin{rubric}
	\textsc{Note,} Within the Octave of the Ascension, the Hymns, Versicles, \& Canticle Antiphons \blackrubric{of Ascension Thursday} (p. \pageref{AscensionThursday}).
\end{rubric}
