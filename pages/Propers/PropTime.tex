...
\begin{rubric}
	The Common of Vigils of the Apostles (p. \pageref{CommonVigilApostles}), Commemoration of the Advent Feria.
\end{rubric}
...
\begin{rubric}
	The Common of Apostles (p. \pageref{CommonApostles}).
\end{rubric}
...
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyrBishopCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of a Confessor not a Bishop (p. \pageref{CommonConfessorNotBishop}), the Versicle \& Antiphon of I Evensong.
\end{rubric}
...
\begin{rubric}
	The Common of a Confessor not a Bishop (p. \pageref{AbbotCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of Virgins (p. \pageref{VirginMartyressCollect}), second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of Virgins (p.\pageref{VirginMartyressCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyrBishopCollect}), second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyrNotBishopCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of a Confessor Bishop (p. \pageref{ConfessorBishopCollect}).
\end{rubric}
...
\hymnLett{Q}{uodcúmque} vinclis super terram strínxeris,
...
\begin{rubric}
	The Common of a Confessor Bishop (p. \pageref{ConfessorBishopDoctorCollect}).
\end{rubric}
...
\begin{rubric}
	Commemoration only is made, unless where he be the patron.
\end{rubric}
...
\begin{rubric}
	The Common of Apostles in Eastertide (p. \pageref{CommonApostlesEaster}).
\end{rubric}
...
\begin{rubric}
	The Common of Apostles in Easter (p. \pageref{CommonApostlesEaster}).
\end{rubric}
...
%CHECK:
\begin{rubric}
	The Common of a Confessor not a Bishop (p. \pageref{ConfessorNotBishopCollect}).
\end{rubric}
...
\begin{rubric}
	Hymns, Versicles, \& Antiphons as on \blackrubric{Michaelmas} (p. \pageref{Michaelmas}).
\end{rubric}
...
\begin{rubric}
	The Common of Virgins (p. \pageref{VirginOnlyCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyrBishopEasterCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of a Martyr in Eastertide (p. \pageref{CommonMartyrBishopEasterCollect}), the second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of Virgins (p. \pageref{VirginOnlyCollect}), the second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of a Confessor not a Bishop (p. \pageref{CommonConfessorNotBishop}), with commemoration \blackrubric{of Sts. Primus \& Felician} (p. \pageref{PrimusFelician}).
\end{rubric}
...
\begin{rubric}
	The Common of a Confessor Bishop (p. \pageref{ConfessorBishopCollect}), the second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of Many Martyrs (p. \pageref{CommonMartyrsNotBishopsCollect}), the second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyrBishopCollect}), the second Collect.
\end{rubric}
...
%%CHECK:
\begin{rubric}
	The Common of Virgins (p. \pageref{VirginMartyressCollect}), the second Collect.
\end{rubric}
...
%%CHECK:
\begin{rubric}
	The Common of Vigils of the Apostles (p. \pageref{CommonVigilApostles}), with Commemoration \blackrubric{of St. Christina,} from the Common of Virgins (p. \pageref{CommonVirgin}), the second Collect.
\end{rubric}
...
\hymnThirdLine{By whose unstained Childbearing}
...
%%CHECK:
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyrNotBishopCollect}), the second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of Virgins (p. \pageref{VirginOnlyCollect}), with a Commemoration \blackrubric{of Sts. Felix, etc} (p. \pageref{FelixEtc}).
\end{rubric}
...
\begin{rubric}
	The Common of the Blessed Virgin Mary (p. \pageref{CommonBVM}), Commemoration \blackrubric{of King St. Oswald} (p. \pageref{Oswald}).
\end{rubric}
...
\festival{Vigil}{9 August}{Vigil of St. Lawrence}{M.}{MartyrRed}
...
%%CHECK:
\begin{rubric}
	The Common of a Confessor not a Bishop (p. \pageref{CommonConfessorNotBishop}), the second Collect. Commemoration \blackrubric{of Sts. Hippolytus \& Cassian} (p. \pageref{HippolytusCassianCollect}).
\end{rubric}
...
\begin{rubric}
	\textsc{Note,} The Versicle \& Antiphon is said in I Evensong \& Mattins.
\end{rubric}
...
\begin{rubric}
	The Common of Holy Matrons (p. \pageref{CommonHolyMatronsCollect}).
\end{rubric}
...
%%CHECK:
\begin{rubric}
	The Common of a Martyr (p. \pageref{CommonMartyr}), the second Collect.
\end{rubric}
...
\begin{rubric}
	The Common of Vigils of the Apostles (p. \pageref{CommonVigilApostles}).
\end{rubric}
...
\begin{rubric}
		\textsc{Note,} The Invitatory Hymn is the \blackrubric{Salve Regina} (p. \pageref{SalveRegina}).
\end{rubric}
...
\begin{rubric}
	The Common of a Confessor not a Bishop (p. \pageref{AbbotCollect}), Commemoration \blackrubric{of Sts. Ursula \& Companions,} from the Common of Virgins (p. \pageref{VirginMartyressesCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of Virgins (p. \pageref{VirginMartyressesCollect}).
\end{rubric}
...
\begin{rubric}
	If to-day be Saturday, the anticipated Vigil of Sts. Simon and Jude is kept, as is noted on the following day.
\end{rubric}


\festival{Vigil}{27 October}{Vigil of Sts. Simon and Jude}{A.}{LentenViolet}
...
\festivalAO{Greater Double}{8 November}{Octave Day of All Hallows}
\feastday{{All Hallows Octave Day}}
\feastdate{8}{November}

\begin{rubric}
	Propers of the Feast (p. \pageref{AllHallows}). Commemoration \blackrubric{of the Four Crowned Martyrs,} from the Common of Many Martyrs (p. \pageref{CommonMartyrsNotBishopsCollect}).
\end{rubric}
...
\begin{rubric}
	The Common of a Dedication of a Church (p. \pageref{CommonDedication}).
\end{rubric}
...
\begin{rubric}
    Commemoration \blackrubric{of St. Mennas,} from the Common of a Martyr (p. \pageref{CommonMartyr}).
\end{rubric}
...
\begin{rubric}
	The Common of the Dedication of a Church (p. \pageref{CommonDedication}).
\end{rubric}
